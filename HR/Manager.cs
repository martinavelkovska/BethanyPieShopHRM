...
namespace BethanyPieShopHRM.HR
{
    ...
    {
        public Manager(string firstName, string lastName, string email, DateTime birthDay, double? hourlyRate) : base(firstName, lastName, email, birthDay, hourlyRate) // in the backgorund it created an employee
        {
        ...
        public override void GiveBonus()
        {
            ...
            {
                Console.WriteLine($"Manager {FirstName} {LastName} received a maangement bonus of 500!");
            }
            else
            {
